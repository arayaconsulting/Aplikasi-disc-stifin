// Data Pertanyaan DISC
const quizQuestions = [
    {
        question: "Saat dihadapkan pada keputusan penting, saya cenderung:",
        options: [
    ...
    {
        question: "Dalam menghadapi konflik, saya biasanya:",
        options: [
    ...
    {
        question: "Ketika bekerja dalam tim, saya cenderung:",
        options: [
    ...
    {
        question: "Saat menghadapi perubahan, saya biasanya:",
        options: [
    ...
    {
        question: "Gaya komunikasi saya lebih cenderung:",
        options: [
    ...
    {
        question: "Dalam menghadapi tekanan deadline, saya:",
        options: [
    ...
    {
        question: "Saat menyampaikan ide, saya lebih suka:",
        options: [
    ...
    {
        question: "Ketika bertugas di proyek baru, saya:",
        options: [
    ...
    {
        question: "Jika ada masalah di tim, saya cenderung:",
        options: [
    ...
    {
        question: "Dalam mengambil keputusan penting, saya:",
        options: [
    ...
    {
        question: "Saat diskusi tim, saya:",
        options: [
    ...
    {
        question: "Ketika diberikan kebebasan, saya:",
        options: [
    ...
    {
        question: "Gaya kerja saya lebih ke arah:",
        options: [
    ...
    {
        question: "Jika tim dalam kondisi tidak ideal, saya:",
        options: [
    ...
    {
        question: "Jika atasan memberi kritik, saya:",
        options: [
    ...
    {
        question: "Dalam tim, saya dikenal sebagai orang yang:",
        options: [
    ...
    {
        question: "Dalam situasi darurat, saya:",
        options: [
    ...
    {
        question: "Saat bekerja, saya lebih suka:",
        options: [
    ...
    {
        question: "Jika harus memilih peran, saya lebih suka:",
        options: [
    ...
    {
        question: "Saat diberi target tinggi, saya:",
        options: [
    ...
    {
        question: "Kalau tim tidak kompak, saya akan:",
        options: [
...
function calculateAndShowResult() {
    ...
    // Perbaikan: gunakan mapping untuk nama lengkap DISC
